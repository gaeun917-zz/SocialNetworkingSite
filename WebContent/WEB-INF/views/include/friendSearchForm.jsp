...
<div class="col-md-offset-2 btn-lg"><h4>학교/지역 : ${param.search}</h4></div>
<div class="col-md-offset-2 btn-lg"><h4>알수도 있는 친구</h4></div>
		...
		<c:forEach var="member" items="${searchByMember}">
			<div class="col-md-offset-2">
				<div class="col-md-4">
					...
					${member.name}<br><input type="button" value="친구요청"  class="btn btn-primary"
