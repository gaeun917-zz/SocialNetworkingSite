            ...
            <div id="inputmain">
                <div class="row">
                    ...
                    <form action="edit.action" method="post">
                        ...
                        <div class="buttons">
                            <input type="submit" class="btn btn-primary" value="편집" style="height: 25px"/>
                            <input type="button" class="btn btn-primary" value="취소" style="height: 25px"
                                   onclick="location.href='/team5/memberdetail/detail.action?' +
