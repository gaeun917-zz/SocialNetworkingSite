				...
				<div id="inputmain">
					...
					<form action="update.action?memberid=${ loginuser.memberId }" method="post">
						...
						<table>
							...
							<tr>
								<th>지역</th>
								<td><input type="text" id="location" name="location" style="width:300px;height:25px"
									value='${ memberinfo.location }' /></td>
							</tr>
							<tr>
								<th>고등학교</th>
								<td><input type="text" id="highschool" name="highschool"
									style="width:300px;height:25px" value='${ memberinfo.highschool }' /></td>
							</tr>

							<tr>
								<th>대학교</th>
								<td><input type="text" id="university" name="university"
									style="width:300px;height:25px" value='${ memberinfo.university }' /></td>
							</tr>

							<tr>
								<th>전화번호</th>
								<td><input type="text" id="phone" name="phone" style="width:300px;height:25px"
