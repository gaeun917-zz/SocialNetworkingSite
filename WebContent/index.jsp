            ...
            <form lass="col-sm-12" class="form-horizontal" action="/team5/register.action" method="post">
                ...
                <div class="radio-inline">
                    ...
                    <label class="radio-inline" id="gender">
                        <input name="gender" value=0 checked="checked" type="radio">남성
                    </label>
                    <label class="radio-inline">
                        <input name="gender" value=1 checked="checked" type="radio">여성
                    </label>
                </div>

                <div class="form-group">
                    <label class="col-sm-12" for="birth">생일</label>
